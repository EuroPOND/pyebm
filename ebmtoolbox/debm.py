...
def fit(data_in,
    ...
    default_method_options = namedtuple('DefaultMethodOptions', 'MixtureModel Bootstrap PatientStaging')
    ...
    idx_ad = pd_data_all['Diagnosis'].values == 3
    idx_mci = pd_data_all['Diagnosis'].values == 2
